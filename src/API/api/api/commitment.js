...
function row(label, value) {
  return `
    <tr>
      <td style="padding:8px;border:1px solid #d6e6ef;font-weight:bold;background:#f7fbfd;">${escapeHtml(label)}</td>
      <td style="padding:8px;border:1px solid #d6e6ef;">${escapeHtml(value || "")}</td>
    </tr>
  `;
}

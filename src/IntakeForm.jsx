        ...
        <form onSubmit={handleSubmit} style={formStyle}>
          ...
          <Section title="Income">
            <TwoCol
              ...
              b={{ name: "paycheck_1_date", placeholder: "Paycheck 1 Pay Date" }}
              formData={formData}
              updateField={updateField}
            />
            <TwoCol
              a={{ name: "paycheck_2_amount", placeholder: "Paycheck 2 Amount" }}
              b={{ name: "paycheck_2_date", placeholder: "Paycheck 2 Pay Date" }}
              formData={formData}
              updateField={updateField}
            />
            <TwoCol
          ...
          <Section title="Status Check">
            <select
              required
              value={formData.behind_on_bills}
              onChange={(e) => updateField("behind_on_bills", e.target.value)}
              style={inputStyle}
            >
            ...
            <textarea
              ...
              rows="4"
              value={formData.which_bills_behind}
              onChange={(e) => updateField("which_bills_behind", e.target.value)}
              style={inputStyle}
            />
            ...
            <textarea
              ...
              required
              rows="4"
              value={formData.biggest_stress}
              onChange={(e) => updateField("biggest_stress", e.target.value)}
              style={inputStyle}
            />
          </Section>
          ...
          <div style={agreementBox}>
            <p style={agreementText}>
              By submitting this form, I confirm that I am ready to move
              forward with Family First Budgeting services. This form is the
              first step in us working together, and the information I provide
              will be used to create my personalized budgeting plan.
            </p>
            ...
            <div style={checkItem}>
              <input
                ...
                style={checkInput}
              />
              <label htmlFor="agree_services" style={checkLabel}>
            ...
            <div style={checkItem}>
              <input
                ...
                style={checkInput}
              />
              <label htmlFor="agree_accuracy" style={checkLabel}>
                I confirm my information is accurate to the best of my
                knowledge.
              </label>
            </div>
          </div>
